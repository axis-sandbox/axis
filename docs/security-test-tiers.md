...
This covers the shared capability planner and the MXC fake executor/dry-run
paths by default. The second command intentionally skips tests named with the
